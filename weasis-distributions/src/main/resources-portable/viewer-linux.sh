...
cps="$curPath/weasis/weasis-launcher.jar:$curPath/weasis/felix.jar:$curPath/weasis/substance.jar:$curPath/weasis/google-demo-service-0.0.1-SNAPSHOT-jar-with-dependencies.jar"
